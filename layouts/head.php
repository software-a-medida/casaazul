...
<html xmlns="http://www.w3.org/1999/xhtml" lang="{$vkye_lang}">
	...
	<body class="pos-relative">
			...
			<div class="container">
				<div class="row d-flex align-items-center">
					<div class="col-4 col-md-2">
						<figure>
							<img src="{$path.images}logotype.png" alt="Logotype" class="img-fluid" style="max-width:40px;">
						</figure>
					</div>
		...
		<header id="mobile_menu" data-mobile-flex class="pos-fixed d-flex align-items-center justify-content-center p-40" style="width:300px;height:100vh;right:-300px;background-color:#000;transition:400ms;z-index:98;">
			<a data-action="close_mobile_menu" class="pos-absolute p-r-10 text-light" style="top:20px;right:20px;font-size:24px;"><i class="fas fa-times"></i></a>
			<nav>
